...
{	
	...
	[ncchange removeObserver:self name:NSHTTPCookieManagerCookiesChangedNotification object:nil];	// don't remove all
	...
	NSNotificationCenter * nctchange = [NSNotificationCenter defaultCenter];
	[nctchange removeObserver:self name:NSManagedObjectContextObjectsDidChangeNotification object:nil];
