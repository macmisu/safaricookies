...
- (NSArray *) cookies
{
	if (_children == nil)
	{
		...
		NSArray * favoriteDomains = [_prefsController favoriteDomains];
...
- (NSArray *) importCookies
{
	if (_children == nil)
	{
		...
		NSArray * favoriteDomains = [[SCPreferences userDefaults] objectForKey:SCPreferencesAcceptCookieDomainsKey];
		NSMutableSet * unusedDomainSet = [NSMutableSet setWithArray:favoriteDomains];
