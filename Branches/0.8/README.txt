...
---------------------------------------------------------
added contextual menu for selecting/deselecting multiple favorites

redundant code cleanup
cookie expiry date formatting
fixed scroll bug
updated remaining legacy code to Objective-C 2.0/Xcode 3
---------------------------------------------------------
