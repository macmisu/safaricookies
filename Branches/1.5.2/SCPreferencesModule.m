...
+ (NSArray *) autoModeDomains
{
	...
	if ([[NSUserDefaults standardUserDefaults] boolForKey:SCPreferencesAutoBookmarksKey])
	{
	...
	if ([[NSUserDefaults standardUserDefaults] boolForKey:SCPreferencesAutoTopSitesKey])
	{
	...
	if ([[NSUserDefaults standardUserDefaults] boolForKey:SCPreferencesAutoHistoryKey])
	{
