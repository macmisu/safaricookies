...
@synthesize versionLabel, tabView, cookiesTreeController, cookiesArrayController, cookiesOutlineView,
			...
			removeAllNonFavoritesButton, removeAllNonFavoritesFlashButton, searchField, flashSearchField,
			numberOfCookiesStatusLine, favoritesPlistExportFilepath, numberOfFlashCookiesStatusLine, plistPath, updater;
