...
{	
	...
	if ([domain characterAtIndex:0] == 'w' && [domain characterAtIndex:1] == 'w' && [domain characterAtIndex:2] == 'w' && [domain characterAtIndex:3] == '.')
...
{	
	...
	if ([[NSUserDefaults standardUserDefaults] boolForKey:SCPreferencesAutomaticMode])
	{
		...
		NSMutableArray *deleteArray = [[NSMutableArray new] autorelease];
		...
		deleteArray = [NSMutableArray arrayWithArray:finalArray];
