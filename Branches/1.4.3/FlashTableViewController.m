...
- (IBAction) removeAllNonFavoriteFlash:(id)sender
{
	...
	if ([[NSUserDefaults standardUserDefaults] boolForKey:SCPreferencesRemoveFlashAlertKey])
	{
...
{	
	if (returnCode == NSAlertSecondButtonReturn)
	{
		...
		{
			[[NSUserDefaults standardUserDefaults] setBool:YES forKey:SCPreferencesRemoveFlashAlertKey];
		}
